...
| 教學參考（請以期交所最新公告為準） |
|-----------------------------------|
| 大台原始保證金：約 **50 萬～60 萬** 量級（2026 年；隨指數高低與波動大幅調整，近年曾在 40 萬上下） |
| 小台約大台的 **1/4**；微台約 **1/10** 量級 |

!!! warning "槓桿"
    用約 50～60 萬保證金，操作合約價值數百萬（如指數 23,000 點 × 200 元 ≈ **460 萬**）的部位 → **槓桿約 8 倍**。專業建議帳戶權益宜為原始保證金的 **3 倍以上**，以降低實質槓桿。
...
|------|------|
| **手續費** | 依期貨商，常為定額或折扣 |
| **期貨交易稅** | 成交價金 × **十萬分之二**（0.00002）；買賣各收一次，以期交所公告為準 |
...
??? question "1.（概念題）期貨與買股票最大的結構差異？"
    參考答案：期貨是**合約 + 保證金 + 到期**，不是持有股票所有權。

??? question "2.（判斷題）小台每點價值約 50 元，漲 100 點就賺 5,000？"
    參考答案：方向正確時**損益約 5,000 元量級**（未扣手續費）；反向則同等虧損，槓桿放大。

??? question "3.（情境題）本站建議散戶怎麼用期貨？"
    參考答案：**輔助判斷**開盤情緒（見 [futures-signal](../09-advanced/futures-signal.md)），現股下單；不必自己炒期貨。
