...
??? question "1.（概念題）市值公式是什麼？"
    參考答案：**股價 × 發行股數**（流通在外股數）；用來衡量公司規模標籤。

??? question "2.（判斷題）股價 500 元一定比 50 元貴、不值得買？"
    參考答案：否。貴便宜看 **PER/PBR 等估值**，不是股價絕對數字。

??? question "3.（情境題）價漲量縮代表什麼？"
    參考答案：上漲但**參與度不足**，動能可能存疑，宜提高警覺。
