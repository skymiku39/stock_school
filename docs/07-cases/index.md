...
| # | 案例 | 主題 | 適用模式 | 相關章節 |
|---|------|------|----------|----------|
| 一 | [月營收轉折](revenue-turn.md) | 基本面轉強 | 中線 | [月營收表](../03-tables/revenue.md) |
| 二 | [鎚子線 + 均線](hammer-ma.md) | K 線反轉 | 短線 | [K 線型態](../04-charts/candle-patterns.md) |
| 三 | [三大法人連續買超](institutional-flow.md) | 籌碼追蹤 | 短中線 | [三大法人表](../03-tables/institutional.md) |
| 四 | [當沖風控決策樹](day-trade-risk.md) | 當沖風控 | 當沖 | [停損三層](../06-risk/stop-loss.md) |
...
| 十八 | [追高陷阱](chase-high-trap.md) | 量縮創高追價 | 短線 | [接盤還是追高](../04-charts/catch-or-chase.md) |
| 十九 | [健康回檔](healthy-pullback.md) | 回檔≠接盤 | 短中線 | [接盤還是追高](../04-charts/catch-or-chase.md) |
...
| **技術型態** | [鎚子線+均線](hammer-ma.md)、[MACD 背離](macd-divergence.md)、[突破缺口](gap-breakout.md)、[弱勢反彈接盤](weak-rebound-trap.md)、[追高陷阱](chase-high-trap.md)、[健康回檔](healthy-pullback.md) | 反轉、背離、缺口、接盤／追高／回檔 |
...
- **完全新手**：先讀案例一、二、五，建立「資料 → 推理 → 結論」的習慣。
- **已選定模式**：直接挑上表對應你模式的案例。
- **老手複盤**：把每篇結論與 [老手陷阱](../09-advanced/veteran-pitfalls.md) 對照自檢。

---

## 自我檢查

??? question "1.（概念題）案例章的標準結構是什麼？"
    參考答案：**背景 → 資料 → 推理 → 結論（教學用）→ 反思**；非投資建議。

??? question "2.（判斷題）讀完案例就可以直接照著買？"
    參考答案：不行。結論皆標示**教學用**；要轉成自己的 [研究流程](../09-advanced/research-workflow.md)。

??? question "3.（情境題）完全新手建議先讀哪幾篇？"
    參考答案：案例**一、二、五**（營收轉折、鎚子均線、估值陷阱），建立推理習慣。

## 重點回顧

- 案例是把 [看表](../03-tables/index.md)、[看圖](../04-charts/index.md)、[分析思維](../05-analysis/index.md) 串起來的實戰。
- 同一套「背景 → 推理 → 反思」結構可套用到你自己的交易。
- 下一步：選一篇對應你模式的案例開始讀。
