...
??? question "1.（概念題）事件交易的核心是什麼，不是公告文字本身？"
    參考答案：**預期差**——市場已預期多少 vs 實際結果。

??? question "2.（判斷題）法說展望優於預期、股價卻大跌，代表利多出盡？"
    參考答案：可能是，但須重評 **thesis**；股價反應不符預期時應依流程調整，非死守原判斷。

??? question "3.（情境題）除息前一天才發現沒查日程，你該怎麼做？"
    參考答案：先查 [除權息日程](../03-tables/dividend-schedule.md) 與 [填息案例](../07-cases/dividend-play.md)；短線參與事件、中長線看 2～3 季驗證。
