...
??? question "1.（概念題）配股配息策略的核心看什麼，不是殖利率排行榜？"
    參考答案：**股利品質與 thesis**——公司獲利能否支撐、EPS 是否跟上配股後股本擴張。

??? question "2.（判斷題）「滾息」策略可以不看除息後基本面？"
    參考答案：不行。滾息重**紀律再投入**，但仍須追蹤獲利與 [除權息日程](../03-tables/dividend-schedule.md)。

??? question "3.（情境題）除息後股價沒填回，你該用哪種策略思維檢視？"
    參考答案：**填息策略**思維——看除息後基本面是否仍成立、是否耐心持有；見 [填息案例](../07-cases/dividend-play.md)。
