...
??? question "1.（概念題）中線主要看哪幾個面向？檢視頻率？"
    參考答案：基本面（營收、財報）＋籌碼（法人），輔以週 K；**每週檢視一次**即可。

??? question "2.（判斷題）持股三天沒漲就換股，適合中線嗎？"
    參考答案：不適合。中線要忍受數週橫盤與洗盤，頻繁換股是典型的「拿中線當短線做」。

??? question "3.（情境題）月營收連兩個月衰退，但股價還沒跌，你會怎麼想？"
    參考答案：營收是中線的核心 thesis，連續衰退是警訊，應重新評估持有理由，見 [月營收表](../03-tables/revenue.md)。
