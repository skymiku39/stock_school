...
??? question "1.（概念題）短線主要靠哪兩個面向判斷？"
    參考答案：**技術面 + 籌碼面**；基本面變化太慢，不是短線的主要依據。

??? question "2.（判斷題）短線「小賺就跑、小虧硬凹」對嗎？"
    參考答案：剛好相反。短線要**小賠快砍**、讓對的單跑一段，否則賠率長期為負。

??? question "3.（情境題）持股跌破關鍵支撐但你想等營收，怎麼辦？"
    參考答案：短線以技術籌碼為準，跌破就依計畫停損；「等營收」是把短線拗成中長線的常見錯誤。

## 重點回顧

- 短線 = 技術 + 籌碼，停損要緊。
- 影片中的 [回測支撐](../02-glossary/technical.md#回測支撐)、[頭肩頂](../02-glossary/technical.md#頭肩頂) 在本模式最常用。
- 案例：[MACD 背離](../07-cases/macd-divergence.md) · [案例：弱勢反彈接盤](../07-cases/weak-rebound-trap.md) · [追高陷阱](../07-cases/chase-high-trap.md) · [健康回檔](../07-cases/healthy-pullback.md) · [軋空](../07-cases/short-squeeze.md)
- 綜合判讀：[手冊：接盤還是追高](../04-charts/catch-or-chase.md)
