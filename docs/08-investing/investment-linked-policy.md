...
!!! warning "「明碼標價」≠「無成本」"
    業務常說費用都寫在表上、沒有隱藏收費——這是指**有揭露**，不是指**你不用付錢**。  
    表上列的前置費、B、管理費、轉換費、基金經理費都是**真實成本**；ETF 類標的若契約規定，仍可能收申購費。  
    完整話術對照 → [業務話術對照表](#業務話術對照表)

---

## 部分提領、解約與加籌 {#部分提領解約與加籌}

變現時最常混淆的三種操作：

| 操作 | 白話 | 前置費 | 常見其他費用 | 契約狀態 |
|------|------|--------|--------------|----------|
| **部分提領** | 從帳戶領一部分現金，**保單繼續** | 通常**不重扣**首年計畫保費前置費 | 提領手續費、保額可能下修（依契約） | 有效 |
| **解約** | 終止契約，領回解約金 | — | 解約費用、已扣 B 不退回 | 終止 |
| **加籌** | 額外繳保費 | **會再扣**前置費（加籌費率） | B 可能因保額調整而變 | 有效 |
...
flowchart TD
    ...
    Q --> B{想多存錢進標的?}
    B -->|是| C[加籌<br/>注意前置費]
    P --> N[不重繳整張保單<br/>但非零成本]
```

| 業務常說 | 你要釐清 |
|----------|----------|
| 「部分提領不解約，不用重繳」 | ✅ 通常指**不必重付首年 60% 那種前置費** |
| | ⚠️ 提領本身、轉換標的、帳戶縮水後的 B 比例仍要問契約 |
| 「長期投資變現也沒關係」 | 部分提領可行，但**領出部位不再享受標的漲幅** |
| 「再投入要重新扣手續費？」 | **加籌**會扣前置費；改用自己買 ETF **通常更透明** |

自己贖回銀行基金 vs 保單部分提領 → 見 [共同基金入門](../01-basics/mutual-fund-intro.md#長期持有變現與手續費)。
...
以下整理實務對話中常見說法與**文件可驗證**的差異（教學用，非針對特定業務員）：

| 業務／簡報說法 | 聽起來像 | 實際要問什麼 | 本站立場 |
|----------------|----------|--------------|----------|
| 「基金年報酬 30%」 | 我會賺 30% | 是**哪一檔、哪一年、淨值還是帳戶**？ | 標的層數字；你的 **IRR** 常遠低於此 |
| 「明碼標價，沒有隱藏費用」 | 買賣完全無成本 | 表上**每一項**加總十年是多少？ | **有揭露 ≠ 零成本** |
| 「長期持有，變現沒關係」 | 隨時領都免費 | 部分提領 vs 解約差別？提領後保額？ | 部分提領可行，**非零成本** |
| 「定期壽險分開買不會更便宜」 | 綁保單最划算 | 拿**同保額**定期壽險報價比較 | 多數人 **ETF + 定期壽險**較透明 |
| 「微笑曲線，逢低買更划算」 | 保單獨有策略 | 跟**ETF 定額**差在哪？ | 定額概念通用；**管道費用**不同 |
| 「投資經理人會電話通知」 | 專人幫你賺 | 通知後績效？加碼是否觸發前置費？ | **參考**，不保證；遇人不淑風險自負 |
| 「每年 6 次免費轉換」 | 換標的免費 | 第 7 次起？ETF 標的申購費？ | 超過常 **NT$500／次**；ETF 可能另收 |
| 「全委託，經理人幫你調」 | 完全不用管 | 是類全委？B、代操費？虧誰負？ | **盈虧自負**；費用仍在 |
| 「幫你操盤，風險我們扛」 | 有保證 | 契約寫**盈虧自負**？ | 標的跌**帳戶照跌** |
| 「公司很多人財富自由」 | 這條路一定行 | 倖存者？離職率？ | 可能是**倖存者偏差** |

### 三層「淨值」釐清

對話中「淨值」常被混用，建議直接問業務指的是哪一層：

| 名詞 | 指什麼 | 你該看的 |
|------|--------|----------|
| **基金淨值（NAV）** | 連結標的每日結算價 | 公開說明書、投信網站 |
| **保單帳戶價值** | 分離帳戶 A 扣持續 B 後 | 對帳單、年度報告 |
| **你的實際 IRR** | 含所有繳費、提領、解約 | 自己試算或請對方算十年 |

實戰情境整理 → [案例：基金與保單實戰問答](../07-cases/fund-policy-faq.md)
...
| 有保險就不會賠 | 標的帳戶**會跌** |
| 加保費 = 純加投資 | **加保額**才會拉高 B |
| 部分提領 = 完全免費 | 通常免**重扣首年前置費**；其他費用依契約 |
| 明碼標價 = 無成本 | 費用**透明列出**，但仍從你口袋出 |
...
| **固定利率傳統壽險** | ❌ 不是 | 投保時鎖定預定利率 | **保險公司** | 報酬低但確定性強 |
...
| 解約金／猶豫期細節 | ⚠️ 略 | [部分提領專節](#部分提領解約與加籌) 已補；解約試算未展開 |
| 業務話術對照 | ✅ | [專節](#業務話術對照表) |
...
??? question "1.（概念題）投資型保單的「投資」部位在哪裡？"
    參考答案：**分離帳戶 A**——不是整筆保費，報酬要扣各層費用與帳戶 B 後才是你的。

??? question "2.（判斷題）簡報寫標的 30% 報酬，就代表保戶能拿到 30%？"
    參考答案：否。那是**標的故事**；保戶拿到的是扣費後帳戶報酬，長期常遠低於標的。

??? question "3.（情境題）多數人若只要投資＋基本保障，預設替代方案是？"
    參考答案：**[ETF 定額](etf-passive-dca.md) + 定期壽險（若需要）**；不必透過保單投資。見 [實戰問答](../07-cases/fund-policy-faq.md)。
...
- **部分提領** ≠ 解約；**加籌**會再扣前置費。
- **明碼標價**是有揭露，不是無成本；見 [話術對照表](#業務話術對照表)。

相關：[共同基金入門](../01-basics/mutual-fund-intro.md) · [實戰問答](../07-cases/fund-policy-faq.md) · [外幣帳戶](insurance-fx-products.md) · [ETF 定額](etf-passive-dca.md) · [資金配置](../06-risk/capital.md)
