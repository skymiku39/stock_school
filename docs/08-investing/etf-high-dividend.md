...
??? question "1.（概念題）高股息 ETF 不等於什麼？"
    參考答案：不等於「比 0050 更穩」或保證高報酬；要看**內扣費、成分品質、配息來源、含息報酬**。

??? question "2.（判斷題）還沒有大盤 ETF 核心，應先買高股息 ETF？"
    參考答案：多數人宜先 **[0050 定額](etf-passive-dca.md)** 建立核心，再評估高股息衛星。

??? question "3.（情境題）想要股息現金流但不想研究個股，決策流程怎麼走？"
    參考答案：先確認是否已有大盤核心 → 若無先定額 → 若有再依本篇**檢查表**評估高股息 ETF，並讀配息公告與含息績效。
