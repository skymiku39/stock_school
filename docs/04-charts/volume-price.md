...
| 價跌量縮 | 跌勢可能趨緩 |
| 突破整理 + 量增 | 突破較可信 |
| 突破整理 + 量縮 | 警惕 [案例：缺口假突破](../07-cases/gap-breakout.md) |
...
| 誤區 | 正確認知 |
|------|----------|
| 價漲量縮一定反轉 | 可能是洗盤或惜售，要看位置與結構 |
| 突破不看量 | 量縮突破警惕 [案例：缺口假突破](../07-cases/gap-breakout.md) |
| 分K量與日量混比 | 週期不同，不可直接比較絕對值 |

## 自我檢查

??? question "1.（概念題）量價圖通常上下兩區各顯示什麼？"
    參考答案：**上**為價格（K線），**下**為成交量柱狀圖。

??? question "2.（判斷題）價漲量增一定會續漲？"
    參考答案：不一定，但多方參與較充分，趨勢延續**機率**較高。

??? question "3.（情境題）整理區向上突破但量縮，你會怎麼做？"
    參考答案：保守看待，等待放量確認或縮小部位；見 [案例：缺口假突破](../07-cases/gap-breakout.md)。
