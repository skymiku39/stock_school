...
|------|----------|
| 單根吞噬就全倉 | 組合仍須看位置與量 |
| 把兩根小K當組合 | 實體吞沒不明確時訊號弱 |
| 忽略前後趨勢 | 晨星在下跌末段才較有意義 |

## 自我檢查

??? question "1.（概念題）吞噬型態的核心條件是什麼？"
    參考答案：後一根**實體**包住前一根實體，方向相反。

??? question "2.（判斷題）組合型態一定比單根可靠？"
    參考答案：通常較高，但**仍非保證**，須搭配位置、量、[均線](ma.md)。

??? question "3.（情境題）低檔鎚子後出現長紅吞噬，你怎麼解讀？"
    參考答案：反轉故事**增強**，但仍要設停損並對照量；見 [鎚子案例](../07-cases/hammer-ma.md)。
