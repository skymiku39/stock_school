...
??? question "1.（概念題）線圖最適合看什麼？"
    參考答案：**收盤價長期趨勢**；大盤／ETF 長期配置常用。

??? question "2.（判斷題）學型態學習應優先線圖還是 K 線？"
    參考答案：**K 線**（實體、影線資訊較完整）。

??? question "3.（情境題）0050 定額投資人日常該盯哪種圖？"
    參考答案：以**週線或月線**看大方向即可，不必每天看分 K；見 [0050 專章](../08-investing/etf-passive-dca.md)。
