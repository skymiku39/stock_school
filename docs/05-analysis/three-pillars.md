...
??? question "1.（概念題）三大支柱各回答什麼問題？"
    參考答案：**基本面**公司好不好、**技術面**何時進出、**籌碼**誰在買賣；互補而非互斥。

??? question "2.（判斷題）法人單日大買超，可以不看基本面直接追？"
    參考答案：不行。籌碼要看**連續性**，且須搭配基本面 thesis，見 [法人表](../03-tables/institutional.md)。

??? question "3.（情境題）存股族應把哪一支柱權重放最高？"
    參考答案：**基本面**（獲利、股利品質）為主，技術面找進場點，籌碼輔助確認。
