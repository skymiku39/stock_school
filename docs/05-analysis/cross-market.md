...
| 誤區 | 正確做法 |
|------|----------|
| 美股漲 → 台股必漲 | 跨市場是**情緒參考**，開高走低常見 |
| ADR 溢價 → 無腦追台股 | 先確認換算比例與匯率，見 [ADR 手算](#adr-折溢價怎麼算) |
| 夜盤大漲 → 市價單追 | 夜盤流動性低、多限價單；勿當成正式盤 |
| VIX 高 → 一定崩盤 | 代表波動預期升，非方向保證 |

## 自我檢查

??? question "1.（概念題）ADR 換算台股等價價位的公式？"
    參考答案：`ADR 股價 ÷ 換算比例 × 匯率`（比例須查官方公告，如 TSM 1:5）。

??? question "2.（判斷題）台指期大幅正價差，當天可以不加驗證就全倉做多？"
    參考答案：不行。期現價差只是情緒參考，仍須看個股 thesis 與 [三大支柱](three-pillars.md)。

??? question "3.（情境題）ADR 等價 960、台股 900，溢價約多少？代表什麼？"
    參考答案：(960−900)/900 ≈ **+6.7%** 溢價；海外定價偏高，可能帶來台股開盤偏強參考，但會收斂、非保證。
