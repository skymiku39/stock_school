...
??? question "1.（概念題）主動 ETF 持股清單能告訴你什麼？"
    參考答案：**機構選股的公開線索**（共識、權重），不是保證獲利的買賣清單。

??? question "2.（判斷題）單一 ETF 新建倉一檔，就可以無腦跟買？"
    參考答案：不行。要看**多檔共識、權重、快照日期**，並用基本面與 K 線驗證。

??? question "3.（情境題）兩期快照顯示某股從無到「新建倉」，你下一步做什麼？"
    參考答案：查 [月營收](../03-tables/revenue.md)、[法人](../03-tables/institutional.md)、[K 線](../04-charts/kline-basics.md)，寫下 thesis 與停損，非立即全倉。
