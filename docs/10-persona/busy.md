...
本頁收錄三種**時間被工作或家庭佔據**的身分。共同主軸是用核心部位（ETF 或中線）省心，再視情況加料。
...
??? question "1.（概念題）忙碌上班族為何不建議當沖或隔日沖？"
    參考答案：**沒時間盯盤與執行紀律**，容易錯過出場變成死抱。

??? question "2.（判斷題）斜槓族可以把短打當全部身家？"
    參考答案：不行。短打是**加料**，核心仍宜 ETF 或中線，並設停損與筆數上限。

??? question "3.（情境題）家計掌權者投資前要先畫清哪三筆錢？"
    參考答案：**生活費、緊急預備、投資閒錢**；見 [資金配置](../06-risk/capital.md)。

## 相關

- [對號入座總覽](index.md) · [中線波段](../08-investing/swing-mid.md) · [資金配置](../06-risk/capital.md)
