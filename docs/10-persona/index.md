...
??? question "1.（概念題）對號入座和「如何選模式」有什麼不同？"
    參考答案：本篇用**身分與生活型態**對照；[如何選模式](../08-investing/choose-style.md) 用時間、隔夜風險、五個自問做篩選。

??? question "2.（判斷題）找到格子後，可以同時當沖、存股又定額嗎？"
    參考答案：新手不宜多模式並行；至少先**固定一種主模式 30 天**，見上方「找到格子之後」。

??? question "3.（情境題）你是上班族、幾乎不能盯盤，表上建議從哪開始？"
    參考答案：中線或 ETF 定額較合理；對照 [忙碌上班族](busy.md) 或 [ETF 定額專章](../08-investing/etf-passive-dca.md)。
