...
本頁為 Stock School 的**字典主索引**：每條含一句話定義與延伸連結。  
需要「誤解、例子、詳解」請點 **詳見** 進入分類專頁。

!!! tip "查詢技巧"
    用瀏覽器 `Ctrl+F` 或站內**搜尋框**（支援中英文縮寫如 `PER`、`MACD`）。
...
| 詞條 | 一句話 | 詳見 |
|------|--------|------|
| 開盤價 | 該時段第一筆成交價 | [開高低收](quotes.md#開高低收) |
...
| IOC | 立即成交否則取消 | [交易流程](../01-basics/trading-flow.md) |
| T+2 交割 | 成交後第 2 營業日交收 | [交割稅費](../01-basics/settlement-fees.md) |
| 手續費 | 券商收取之交易費用 | [交割稅費](../01-basics/settlement-fees.md) |
| 證交稅 | 賣出時課徵之稅 | [交割稅費](../01-basics/settlement-fees.md) |
...
| 反彈 | 下跌中暫時上漲 | [反彈](trading-terms.md#反彈) |
| 套牢 | 虧損不願賣出 | [套牢解套](trading-terms.md#套牢解套) |
| 解套 | 回升至成本以上 | [套牢解套](trading-terms.md#套牢解套) |
...
| 詞條 | 一句話 | 詳見 |
|------|--------|------|
| 上市 / 上櫃 | 台交所 / 櫃買掛牌 | [市場概覽](../01-basics/market-overview.md) |
| 多頭 / 空頭 | 大盤偏多/偏空趨勢 | [多頭空頭](market-terms.md#多頭空頭) |
| 資金行情 | 熱錢推升之行情 | [資金行情](market-terms.md#資金行情) |
| 跳空 | 開盤與昨收無成交斷層 | [跳空](market-terms.md#跳空) |
| 缺口 | 圖上未成交價格帶 | [缺口](market-terms.md#缺口) |
| 回補缺口 | 價格進入缺口區間 | [回補缺口](market-terms.md#回補缺口) |
| 軋空 | 空頭被迫回補推升價 | [軋空](market-terms.md#軋空) |
| 盤堅 / 盤軟 | 緩步上/下行 | [盤堅盤軟](market-terms.md#盤堅盤軟) |
| 打底 | 底部反覆震盪墊高 | [打底](market-terms.md#打底) |
| 破底 | 跌破支撐低點 | [破底](market-terms.md#破底) |
| 主力 | 能影響股價之大戶 | [主力抬轎](market-terms.md#主力抬轎) |
| 洗盤 | 震盪洗出散戶 | [洗盤](market-terms.md#洗盤) |
| 利多出盡 | 消息落地反向走 | [利多利空出盡](market-terms.md#利多利空出盡) |
| 量價背離 | 價與量方向不一致 | [量價背離](market-terms.md#量價背離) |
| ETF | 交易所買賣之基金 | [ETF](../01-basics/etf-intro.md) |
...
| 折溢價 | ETF市價與淨值之差距 | [ETF費用與折溢價](../01-basics/etf-costs-and-premium.md) |
| 收益平準金 | ETF配息會計機制，非額外獲利 | [ETF費用與折溢價](../01-basics/etf-costs-and-premium.md) |
| 高股息ETF | 偏重股息策略之ETF | [高股息ETF](../08-investing/etf-high-dividend.md) |
| 台指期 | 加權指數期貨合約 | [期貨入門](../01-basics/futures-intro.md) |
| 大台指 | 台指期標準合約（TX） | [期貨入門](../01-basics/futures-intro.md) |
| 小台指 | 大台1/4規模（MTX） | [期貨入門](../01-basics/futures-intro.md) |
| 原始保證金 | 期貨建倉前帳戶最低金額 | [期貨入門](../01-basics/futures-intro.md) |
| 維持保證金 | 期貨持倉期間權益底線 | [期貨入門](../01-basics/futures-intro.md) |
