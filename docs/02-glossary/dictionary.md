...
| 詞條 | 英文 | 一句話 | 詳見 |
|------|------|--------|------|
| 開盤價 | Opening price | 該時段第一筆成交價 | [開高低收](quotes.md#開高低收) |
...
| IOC | Immediate or Cancel | 立即成交否則取消 | [交易流程](../01-basics/trading-flow.md) |
| T+2 交割 | T+2 settlement | 成交後第 2 營業日交收 | [交割稅費](../01-basics/settlement-fees.md) |
| 手續費 | Brokerage fee | 券商收取之交易費用 | [交割稅費](../01-basics/settlement-fees.md) |
| 證交稅 | Securities transaction tax | 賣出時課徵之稅 | [交割稅費](../01-basics/settlement-fees.md) |
...
| 詞條 | 英文 | 一句話 | 詳見 |
|------|------|--------|------|
| K 線 / K 棒 | Candlestick | 開高低收之蠟燭圖 | [K 線基礎](../04-charts/kline-basics.md) |
| 實體 | Real body | 開收之間區塊 | [K 線基礎](../04-charts/kline-basics.md) |
| 影線 | Shadow (wick) | 最高最低延伸線 | [K 線基礎](../04-charts/kline-basics.md) |
| 紅K / 黑K | Bullish / Bearish candle | 收≥開 / 收<開（台股） | [K 線基礎](../04-charts/kline-basics.md) |
| 線圖 | Line chart | 連接收盤之趨勢線 | [線圖](../04-charts/line-charts.md) |
| 分時圖 | Intraday chart | 當日走勢曲線 | [分時圖](../04-charts/intraday-charts.md) |
...
| 缺口 | Price gap | 圖上未成交價格帶 | [缺口](market-terms.md#缺口) |
| 回補缺口 | Gap fill | 價格進入缺口區間 | [回補缺口](market-terms.md#回補缺口) |
| 軋空 | Short squeeze | 空頭被迫回補推升價 | [軋空](market-terms.md#軋空) |
| 盤堅 / 盤軟 | Grinding up / down | 緩步上/下行 | [盤堅盤軟](market-terms.md#盤堅盤軟) |
| 打底 | Bottoming | 底部反覆震盪墊高 | [打底](market-terms.md#打底) |
...
| 定期定額 | Dollar-cost averaging (DCA) | 固定週期固定金額買入 | [0050 與定期定額](../08-investing/etf-passive-dca.md) |
| 被動型ETF | Passive ETF | 追蹤指數，持股隨指數調整 | [ETF入門](../01-basics/etf-intro.md) |
| 006208 | — | 追蹤台灣50的被動ETF（富邦） | [ETF費用與折溢價](../01-basics/etf-costs-and-premium.md) |
| 內扣費用 | Expense ratio | 管理費等每日從淨值扣除 | [ETF費用與折溢價](../01-basics/etf-costs-and-premium.md) |
| 折溢價 | Premium / Discount | ETF市價與淨值之差距 | [ETF費用與折溢價](../01-basics/etf-costs-and-premium.md) |
| 收益平準金 | Income equalization reserve | ETF配息會計機制，非額外獲利 | [ETF費用與折溢價](../01-basics/etf-costs-and-premium.md) |
| 高股息ETF | High-dividend ETF | 偏重股息策略之ETF | [高股息ETF](../08-investing/etf-high-dividend.md) |
| 台指期 | TAIEX futures | 加權指數期貨合約 | [期貨入門](../01-basics/futures-intro.md) |
| 大台指 | TX (TAIEX futures) | 台指期標準合約（TX） | [期貨入門](../01-basics/futures-intro.md) |
...
| 詞條 | 英文 | 一句話 | 詳見 |
|------|------|--------|------|
| 當沖模式 | Day trading | 當日沖銷策略 | [當沖](../08-investing/day-trade.md) |
| 隔日沖 | Overnight trade | 持有 1～3 日 | [隔日沖](../08-investing/overnight.md) |
| 短線 | Short-term swing | 數日～2 週 | [短線](../08-investing/swing-short.md) |
| 中線波段 | Medium-term swing | 數週～數月 | [中線波段](../08-investing/swing-mid.md) |
| 長期投資 | Long-term investing | 數月～年 | [長期投資](../08-investing/long-term.md) |
| 存股 | Dividend buy-and-hold | 重配息長抱 | [存股除權息](../08-investing/dividend-investing.md) |
| ETF 配置 | ETF allocation | 一籃子分散、常見定額 | [ETF 配置](../08-investing/etf-investing.md) |
| 投資型保單 | Investment-linked policy | 連結基金之保險契約 | [投資型保單](../08-investing/investment-linked-policy.md) |
| 保險成本 B | Insurance cost (mortality charge) | 投資型保單每月扣的危險保費 | [投資型保單](../08-investing/investment-linked-policy.md) |
| 對號入座 | Persona matching | 依身分找適合投資模式（12 型） | [對號入座](../10-persona/index.md) |
| 閒錢 | Spare capital | 短時間內不動用的投資資金 | [資金配置](../06-risk/capital.md#閒錢與生活費) |
...
- 本頁 = **字典主索引**；分類專頁 = **詳解**。
- 英文欄方便站內搜尋與對照外文資料；縮寫權威以 [縮寫對照](../appendix/abbreviations.md) 為準。
