...
## Priced In（已反映於股價） {#priced-in}

| 項目 | 說明 |
|------|------|
| **英文** | Priced in |
| **定義** | 利多或利空已被市場**預期並反映在股價**，正式消息公布當下反而不漲甚至反向 |
| **在哪裡看到** | 法說／財報公布日股價反向、[好公司好股票](../05-analysis/fundamental-framework.md#好公司好股票) |
| **常見誤解** | 好消息公布就該追；若已提前漲過，可能是 [利多出盡](#利多利空出盡) |
| **小例子** | 展望佳但股價三個月已漲 50% → 公布當天開高走低 |
...
??? question "1.（概念題）填息與填權有何不同？"
    參考答案：**填息**是除息後價格修復；**填權**是除權後修復；皆須搭配基本面。

??? question "2.（判斷題）量價背離出現就應立刻反轉？"
    參考答案：否。背離僅為**警訊**，需其他指標與位置確認。

??? question "3.（情境題）跳空與缺口常如何一起理解？"
    參考答案：**跳空**是開盤與昨收斷層；**缺口**是圖上未成交價格帶，常一起出現。
