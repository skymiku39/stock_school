...
??? question "1.（概念題）突發狀況時，第一個要分辨的是什麼？"
    參考答案：**情緒性波動** vs **[投資論點](../09-advanced/research-workflow.md) 真的失效**。

??? question "2.（判斷題）跌停鎖死時，可以臨時取消停損改死抱？"
    參考答案：不應臨時改規則；事前 [停損](stop-loss.md) 是契約，事後複盤調整下次計畫。

??? question "3.（情境題）除息前一天才買進想賺股利，為何常不划算？"
    參考答案：股價已反映、還有股利稅與可能**二代健保 2.11%**；見 [除息誤操作案例](../07-cases/ex-dividend-mistake.md)。
