...
??? question "1.（概念題）「圖看趨勢，表看數字」代表什麼？"
    參考答案：圖表看型態走勢；表格看**精確數字**；宜對照，見 [圖表總覽](../04-charts/index.md)。

??? question "2.（情境題）中線波段族優先該看哪幾張表？"
    參考答案：**月營收、三大法人、評分量表**；見本篇「依投資模式選表」。

??? question "3.（判斷題）評分量表分數可以直接當買賣指令？"
    參考答案：不行。分數是粗篩，進出場仍依該模式的 [停損](../06-risk/stop-loss.md) 與 [紀律](../06-risk/discipline.md)。
