...
| 來源 | 路徑 |
|------|------|
| 台灣證券交易所 / 櫃買中心 | 鉅額交易日報（盤後或次日） |
| 券商看盤軟體 | 個股「鉅額／成交明細」分頁 |
| 財經網站 | 鉅額交易統計 |

統計與一般盤中撮合分開，公布時間依資料源。資料源細節見 [資料來源](../appendix/data-sources.md)。

## 手算一例 {#手算一例}

以示意表 **2330 D0 買進**這一列，驗證金額欄：

```
金額(百萬) = 成交價 × 張數 × 1,000 ÷ 1,000,000
          = 848 × 500 × 1,000 ÷ 1,000,000
          = 424 百萬
```

與表中 **424** 一致。相對昨收 **+0.2%** 代表大戶以略高於昨收價成交，屬溢價買進的參考訊號（仍須對照股價位置與法人表）。
...
把鉅額表與 [三大法人連續買超案例](../07-cases/institutional-flow.md) 對照：練習用「大單事件 + 法人趨勢 + 股價位置」三者交叉，而非單看一筆大單。
